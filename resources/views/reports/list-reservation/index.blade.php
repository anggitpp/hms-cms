...
@section('content')
    <div class="card">
        <div class="card-header justify-content-between">
            ...
            <a href="{{ route('reports.list-reservation.exportExcel', ['filter' => $filter, 'filterHotel' => $filterHotel, 'filterDate' => $filterDate]) }}" class="btn btn-success"><i data-feather='file'></i> Export Data</a>
        </div>
