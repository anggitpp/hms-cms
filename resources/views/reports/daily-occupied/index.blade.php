...
@section('content')
    <div class="card">
        <div class="card-header justify-content-between">
            ...
            <a href="{{ route('reports.daily-occupied.exportExcel', ['filter' => $filter, 'filterHotel' => $filterHotel, 'filterDate' => $filterDate]) }}" class="btn btn-success"><i data-feather='file'></i> Export Data</a>
        </div>
        <div class="table-responsive">
            <table class="table">
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" align="right"><b><i>Total Room Occupied</i></b></td>
                        <td><b>{{ $totalOccupied ?? 0 }}</b></td>
                    </tr>
                </tfoot>
            </table>
