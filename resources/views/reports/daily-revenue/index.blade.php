...
@section('content')
    <div class="card">
        <div class="card-header justify-content-between">
            ...
            <a href="{{ route('reports.daily-revenue.exportExcel', ['filter' => $filter, 'filterHotel' => $filterHotel, 'filterDate' => $filterDate]) }}" class="btn btn-success"><i data-feather='file'></i> Export Data</a>
        </div>
        <div class="table-responsive">
            <table class="table">
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" align="right"><b><i>Total Revenue</i></b></td>
                        <td align="right"><b>{{ setCurrency($totalRevenue) }}</b></td>
                    </tr>
                </tfoot>
            </table>
