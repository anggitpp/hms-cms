    ...
    <div class="card">
        <div class="card-header justify-content-between">
            ...
            @if(isset($access['create']))
                <a href="{{ route('masters.room-additionals.create', $filterHotel) }}" class="btn btn-primary"><i data-feather='plus'></i> Tambah Additional</a>
            @endif
        </div>
        <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                @if(isset($access['edit']))
                                    <a href="{{ route('masters.room-additionals.edit', [$r->id, $filterHotel]) }}" class="btn btn-icon btn-primary"><i data-feather="edit"></i></a>
                                @endif
                                @if(isset($access['destroy']))
                                    <button href="{{ route('masters.room-additionals.destroy', $r->id) }}" id="delete" class="btn btn-icon btn-danger">
            ...
            {{ generatePagination($additionals) }}
