...
use App\Exports\Report\ListReservationExport;
...
class ListReservationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return !empty($this->access('index')) ? view('reports.list-reservation.index', $data) : abort(401);    }
