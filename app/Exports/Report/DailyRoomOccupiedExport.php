...
class DailyRoomOccupiedExport implements FromCollection, WithHeadings, WithColumnWidths, WithStyles, WithCustomStartCell
{
    protected $filter;
    ...
    */
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A'.$highestRow, 'Total Room Occupied');
        ...
        $sheet->setTitle('Laporan Daily Occupied');
    }
