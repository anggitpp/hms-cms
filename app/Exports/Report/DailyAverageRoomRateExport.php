...
class DailyAverageRoomRateExport implements FromCollection, WithHeadings, WithColumnWidths, WithStyles, WithCustomStartCell
{
    protected $filter;
    ...
    public function collection()
    {
        ...
        $arrData[$no]['price'] = '';
        $arrData[$no]['discount'] = '';
        $arrData[$no]['revenue'] = setCurrency($averageRoomRate);
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->setCellValue('A'.$highestRow, 'Total Average Room Rate');
        ...
        $sheet->setTitle('Laporan Daily Average Rate');
    }
